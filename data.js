...
window.DASHBOARD_DATA = {
  ...
  fixedAssets: [
    { id:'fa1', name:'Mac Mini M4', category:'Electronics', purchaseDate:'2026-06-24', cost:13116500, usefulLifeMonths:48, transactionRef:'t32', notes:'Dibeli via CC Permata Cashback Card. Monthly depreciation: Rp273,260.' }
  ],
  transactions: [
    // === BEGIN BALANCE ===
    ...
    {id:'t18',date:'2026-06-21',type:'Out',category:'Marketplace / Other',account:'BCA 730',amount:187091,desc:'GoPay Later - Tokopedia (3 transaksi, 21 Mei-19 Jun)'},
    ...
    {id:'t25',date:'2026-06-23',type:'Out',category:'Liability Payment - KTA',account:'CIMB 707',amount:2837444,desc:'Auto-debit KTA Xtra Dana — cicilan Rp2,637,444 + late charge Rp200,000. (Balance sheet: liability reduction. Split interest pending rate dari CIMB.)'},
    ...
    {id:'t30',date:'2026-06-24',type:'Out',category:'Liability Payment - CC',account:'Permata 412 (Payroll)',amount:2360448,desc:'Bayar tagihan CC Permata Cashback Card (****9447) — balance sheet: CC outstanding reduction.'},
    ...
    {id:'t32',date:'2026-06-24',type:'Out',category:'Fixed Asset Purchase',account:'Permata Cashback Card',amount:13116500,desc:'Purchase Mac Mini M4 → Fixed Asset fa1 (depreciate 48 bln, Rp273,260/bln). Diakui di balance sheet, bukan P&L.'},
    ...
    {id:'t34',date:'2026-06-24',type:'Out',category:'Electronics & Accessories',account:'BCA 730',amount:900350,desc:'Kebutuhan support Mac Mini - Keyboard, HDMI, KVM, stop kontak ampere'},
    ...
    {id:'t41',date:'2026-06-25',type:'Out',category:'Liability Payment - CC',account:'CIMB 200',amount:500134,desc:'Bayar cicilan CC CIMB Plat Syariah — balance sheet: CC outstanding reduction.'},
    ...
    {id:'t44',date:'2026-06-25',type:'Out',category:'Family - Toys & Education',account:'BCA 730',amount:77510,desc:'Mainan anak'},
    {id:'t45',date:'2026-06-25',type:'Out',category:'Electronics & Accessories',account:'BCA 730',amount:141689,desc:'Kabel Type C & HDMI (kebutuhan Mac Mini)'},
    {id:'t46',date:'2026-06-25',type:'Out',category:'Family - Diapers & Essentials',account:'BCA 730',amount:364671,desc:'Pampers Mamypoko Royalsoft 3 bundle isi 52 ukuran L'},
    {id:'t47',date:'2026-06-25',type:'Out',category:'Family - Nutrition',account:'BCA 730',amount:1037276,desc:'Susu Morinaga Chilkid Vanilla 800gr 1-3 Tahun 4 pcs'},
  ...
  budgets: {
    // --- FAMILY ---
    'Family - Diapers & Essentials': 500000,
    'Family - Nutrition': 1200000,
    'Family - Toys & Education': 200000,
    'Family - Health': 0,
    // --- LIVING ---
    'Meals': 1000000,
    'Listrik': 1000000,
